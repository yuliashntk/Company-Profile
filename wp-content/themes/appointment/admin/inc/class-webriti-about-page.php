...
function appointment_recommended_plugins_array($plugins){
	...
	$plugins[] = array(
					...
					'function'     => '',
					'class'     => 'OCDI_Plugin',
					'desc'     => esc_html__('It is recommended that you install the One Click Demo Import plugin to import the default demo data and starter sites', 'appointment'),
				);
	...
	$plugins[] = array(
					...
					'class'     => '',
					'desc'     => esc_html__('It is recommended that you install the Elementor plugin to import the elementor starter sites', 'appointment'),
				);
	return $plugins;
}
